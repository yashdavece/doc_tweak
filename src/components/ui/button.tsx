  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-white font-semibold shadow-card hover:shadow-elegant hover:scale-105",
        business: "gradient-business text-white font-semibold shadow-business hover:shadow-elegant hover:scale-105",
        student: "gradient-student text-white font-semibold shadow-student hover:shadow-elegant hover:scale-105",
      },
      size: {
