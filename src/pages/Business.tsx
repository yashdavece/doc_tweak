  ...
  return (
    <div className="container mx-auto p-6 space-y-6 max-w-4xl">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-2">Business Document Enhancement</h1>
        <p className="text-lg text-muted-foreground">
          Improve your business documents with AI-powered enhancements
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Textarea
                id="context"
                placeholder="e.g., Make it more professional, simplify technical terms..."
                value={context}
